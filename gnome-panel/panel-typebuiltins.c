...
static const GEnumValue _panel_alignment_values[] = {
  { PANEL_ALIGNMENT_START, "PANEL_ALIGNMENT_START", "start" },
  { PANEL_ALIGNMENT_CENTER, "PANEL_ALIGNMENT_CENTER", "center" },
  { PANEL_ALIGNMENT_END, "PANEL_ALIGNMENT_END", "end" },
  { 0, NULL, NULL }
};

GType
panel_alignment_get_type (void)
{
  static GType type = 0;

  if (!type)
    type = g_enum_register_static ("PanelAlignment", _panel_alignment_values);
